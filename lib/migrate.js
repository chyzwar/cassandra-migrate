...
var checkFormat = require("./helpers/checkFormat");

program.version("0.2.1").description("Cassandra migration tool");

program.command("create <migration>").description("create new migration").option("-d, --directory [directory]", "migrations directory", "migrations").option("-e, --envirotment [envirotment]", "node envirotment", "local").option("-l, --logger [logger]", "logger module", "server/logger").option("-f, --format [format]", "migration format", "cql").action(function (migration, _ref) {
  ...
  create(envirotment, migration, directory, logger, format);
});

program.command("up").description("run outstanding migrations").option("-d, --directory [directory]", "migrations directory", "migrations").option("-e, --envirotment [envirotment]", "node envirotment", "local").option("-l, --logger [logger]", "logger module", "server/logger").option("-c, --client [client]", "db client module", "server/db").action(function () {
