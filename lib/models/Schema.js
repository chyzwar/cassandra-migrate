  ...
  _createClass(Schema, [{
    ...
    value: function getMigrations(directory) {
      return this.migrations.rows.map(function (migration) {
        return Migration.load(migration, directory);
      });
    }
    ...
    value: function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(migration) {
        var _migration$migration$, query, params, filename;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _migration$migration$ = migration.migration.up, query = _migration$migration$.query, params = _migration$migration$.params, filename = migration.filename;
                _context4.next = 4;
    ...
    value: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(migration) {
        var _migration$migration$2, query, params, filename;

        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _migration$migration$2 = migration.migration.down, query = _migration$migration$2.query, params = _migration$migration$2.params, filename = migration.filename;
                _context5.next = 3;
                return this.client.execute(query, params, { prepare: true });
